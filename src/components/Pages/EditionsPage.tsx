...
import { BookMarked, Download, BookOpen, CheckCircle2, ArrowRight } from 'lucide-react';
...
export const EditionsPage: React.FC<EditionsPageProps> = ({ onOpenEdition, onShowToast }) => {
  return (
          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-between h-full">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2 border-t border-gray-100">
                ...
                <button
                  onClick={() => onShowToast(`A descarregar PDF da ${ed.title}...`)}
